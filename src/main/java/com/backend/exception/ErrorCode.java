...
public enum ErrorCode {
    ...
    EVENT_NOT_STARTED(1044, "Giải đấu chưa chính thức bắt đầu", HttpStatus.BAD_REQUEST),
    PREVIOUS_ROUND_NOT_ENDED(1045, "Vòng thi trước chưa kết thúc", HttpStatus.BAD_REQUEST),
